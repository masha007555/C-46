...
function setup() {
  ...
  hBar = createSprite(1200,110,100,20);
  hBar.shapeColor = "blue";
  // hBar1 = createSprite(1200,110,100,20);
...
function draw() {
  ...
  hBar1Width = health;
  hBar1 = createSprite(1200,110,hBar1Width,20);
  hBar1.shapeColor = "red";
  console.log(hBar1Width);
  hBar1.lifetime = 1;
...
function stages(){
  ...
  if (mousePressedOver(s1) && current === 1){
    click.play();
    gameState = "stage1";
  }
  if (mousePressedOver(s2) && current === 2){
    click.play();
    gameState = "stage2";
  }
  if (mousePressedOver(s3) && current === 3){
    click.play();
    gameState = "stage3";
  }
  if (mousePressedOver(s4) && current === 4){
    click.play();
    gameState = "stage4";
  }
  if (mousePressedOver(s5) && current === 5){
    click.play();
    gameState = "stage5";
  }
  if (mousePressedOver(s6) && current === 6){
    click.play();
    gameState = "stage6";
  }
  if (mousePressedOver(s7) && current === 7){
    click.play();
    gameState = "stage7";
  }
...
function Hshoot(){
  Hbullet= createSprite(1200,helicopter.y, 10, 10);
